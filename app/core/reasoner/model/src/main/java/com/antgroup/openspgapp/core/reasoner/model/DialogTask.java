...
/* loaded from: core-reasoner-model-0.0.1-SNAPSHOT.jar:com/antgroup/openspgapp/core/reasoner/model/DialogTask.class */
public class DialogTask {
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof DialogTask)) {
      return false;
    }
    DialogTask other = (DialogTask) o;
  ...
  protected boolean canEqual(final Object other) {
    return other instanceof DialogTask;
  }
