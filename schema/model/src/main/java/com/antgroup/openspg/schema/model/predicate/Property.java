...
package com.antgroup.openspg.schema.model.predicate;

import com.antgroup.openspg.schema.model.BaseSpoTriple;
 ...
 *
 * <p>Property is generally defined on a unary object and is used to describe information about
 * entity portrait features. In the RDF knowledge framework, Property is an SPO triplet structure,
 * and under the SPG framework, Property is not only triplet structure, but also can define extended
 * information such as constraints and sub properties. The object type of an property can not only
 * be a basic type, but also a semantic type such as standard type, concept type or entity type etc.
 * if the object is a semantic type, the property can be used as a relation. Property of a spg type
 * can be inherited from its parent class or defined by itself, ensuring that the property name of
 * an entity type is unique. The value of a property can be dynamically calculated through a KGDSL
 * script, rather than being imported during knowledge processing. We call this property a logical
 * property.
 *
 * <p>Usually the instance of property is called PropertyRecord, and the schema of property is
 * called Property.
 */
