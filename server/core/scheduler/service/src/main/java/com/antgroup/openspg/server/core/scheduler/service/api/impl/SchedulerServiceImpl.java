...
public class SchedulerServiceImpl implements SchedulerService {
    ...
    private ThreadPoolExecutor instanceExecutor = new ThreadPoolExecutor(1, 20, 30, TimeUnit.MINUTES, new LinkedBlockingQueue<>(100),
            runnable -> {
    ...
    public Boolean stopInstance(Long id) {
        ...
        schedulerCommonService.setInstanceFinish(instance, InstanceStatus.TERMINATE, TaskStatus.TERMINATE);
        return true;
    }
    ...
    public Boolean setFinishInstance(Long id) {
        SchedulerInstance instance = schedulerInstanceService.getById(id);
        Assert.notNull(instance, String.format("instance not find id:%s", id));
        schedulerCommonService.setInstanceFinish(instance, InstanceStatus.SET_FINISH, TaskStatus.SET_FINISH);
        return true;
    }
