...
import com.antgroup.openspg.server.core.schema.model.type.SPGTypeAdvancedConfig;
...
/**
 * The convertor between BaseSpgType and SimpleSpgType, provides method to convert BaseSpgType to
 * SimpleSpgType, and method to convert SimpleSpgType to BaseSpgType.
 */
public class SPGTypeConvertor {
  ...
  private static List<OperatorConfig> getOperatorKey(SPGTypeAdvancedConfig advancedConfig) {
    ...
    if (advancedConfig.getLinkOperator() != null) {
      operatorConfigs.add(
          new OperatorConfig(advancedConfig.getLinkOperator(), OperatorTypeEnum.ENTITY_LINK));
    }
    if (advancedConfig.getFuseOperator() != null) {
      operatorConfigs.add(
          new OperatorConfig(advancedConfig.getFuseOperator(), OperatorTypeEnum.ENTITY_FUSE));
    }
    if (advancedConfig.getExtractOperator() != null) {
      operatorConfigs.add(
          new OperatorConfig(
              advancedConfig.getExtractOperator(), OperatorTypeEnum.KNOWLEDGE_EXTRACT));
    }
    if (advancedConfig.getNormalizedOperator() != null) {
      operatorConfigs.add(
          new OperatorConfig(
              advancedConfig.getNormalizedOperator(), OperatorTypeEnum.PROPERTY_NORMALIZE));
    }
  ...
  public static List<BaseSPGType> toBaseSpgType(List<SimpleSPGType> simpleSpgTypes) {
    ...
    return simpleSpgTypes.stream()
        .map(e -> toBaseSpgType(e, new ArrayList<>(), new ArrayList<>()))
  ...
  public static BaseSPGType toBaseSpgType(
      SimpleSPGType simpleSpgType, List<Property> propertys, List<Relation> relations) {
