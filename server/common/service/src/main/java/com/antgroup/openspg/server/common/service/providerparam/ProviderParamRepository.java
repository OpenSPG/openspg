 ...
 * or implied.
 */
package com.antgroup.openspg.server.common.service.providerparam;
...
public interface ProviderParamRepository {
  ...
  List<ProviderParam> query(ProviderParamQuery record);
