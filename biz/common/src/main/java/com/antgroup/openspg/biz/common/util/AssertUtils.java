...
public class AssertUtils {
     ...
     */
    public static void assertParamCollectionIsNotEmpty(
        String objectName,
    ...
    /**
     * Asserts that a number is within a given range, where the minimum value is less than or equal to the number and
     * the maximum value is greater than or equal to the number.
     *
     * @param objectName The name of the object
     * @param object     The object to be validated
     * @param min        The minimum value
