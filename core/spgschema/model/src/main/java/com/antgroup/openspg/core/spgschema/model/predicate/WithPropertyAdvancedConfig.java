...
public interface WithPropertyAdvancedConfig {
    ...
    default List<SubProperty> getSubProperties() {
        return getAdvancedConfig() != null ? getAdvancedConfig().getSubProperties() : Collections.emptyList();
    }
    ...
    default List<PredicateSemantic> getSemantics() {
        return getAdvancedConfig() != null ? getAdvancedConfig().getSemantics() : Collections.emptyList();
    }
