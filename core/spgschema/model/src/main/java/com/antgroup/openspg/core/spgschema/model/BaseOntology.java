 ...
 * <p>
 * In the RDF framework, knowledge is represented by a triple of <subject, predicate, object>. The subject and object
 * can be entities, concepts, events, or constants such as text and numbers. The predicate can be properties or
 * relations. These combinations are referred to as ontologies. Ontology, originating from philosophy, is a concept that
 * denotes "a formalized, clear, and detailed description of a shared concept system". It is used to guide cognitive
 * modeling of entities, terms, and concepts within a specific domain in the real world, as well as to define the schema
 * of knowledge graph.
 * </p>
 */
