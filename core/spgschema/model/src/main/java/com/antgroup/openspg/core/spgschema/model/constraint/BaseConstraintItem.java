...
/**
 * Abstract class of constraint item, describes one kind of condition that property value should be meet, the
 * implemented class has such as {@link EnumConstraint}, {@link UniqueConstraint}, {@link MultiValConstraint},
 * {@link NotNullConstraint}, {@link RangeConstraint}, {@link RegularConstraint} etc.
 */
public abstract class BaseConstraintItem extends BaseToString
    ...
    public int compareTo(BaseConstraintItem o) {
        return Integer.compare(
            this.getConstraintTypeEnum().getPriority(),
            o.getConstraintTypeEnum().getPriority()
        );
    }
}
