 ...
 * <p>
 * A relation is usually defined between binary objects to describe the existence of a certain connection between two
 * entities. Relation can be regarded as a special property and is also SPO triplet structure, with object types
 * generally being {@link EntityType}.
 * </p>
 * <p>
 * Like {@code Property}, we can define some sub properties for {@code Relation} to describe its extended information,
 * and we can use {@code SystemPredicate} to define the semantics between {@code Relation}. Also, we can define KGDSL
 * script to calculate whether a {@code Relation} exists.
 * </p>
 * <p>
 * Usually the instance of relation is called RelationRecord, and the schema of relation is called Relation.
 * </p>
 */
public class Relation extends Property {
    ...
    public Relation(
        ...
        this(basicInfo, subjectTypeRef, objectTypeRef, inherited,
