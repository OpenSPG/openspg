...
public class SchemaConstants {
     ...
     */
    public final static String WITH_COMMON_INDEX = "commonIndex";
    ...
    /**
     * Default version of ontology record in db. Currently, system does not support multiple versions of ontology, so
     * it's fixed to be 1.
     */
