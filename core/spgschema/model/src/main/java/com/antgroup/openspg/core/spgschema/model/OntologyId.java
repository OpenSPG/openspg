...
/**
 * Value object of ontology ID, each ontology has a unique id, which can be either a serialized ID generated by the
 * database or a semantic ID with meaningful business information.
 */
