 ...
 * <p>
 * Each ConceptType is a kind of Classification of entity, it usually has a tree hierarchy, So we can specify a name for
 * each level of the concept tree to better express the hierarchical structure of the concept。<br> Taking administrative
 * divisions as an example, the layer config can be: country, province, city, district.
 * </p>
 */
