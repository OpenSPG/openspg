...
/**
 * Interval range constraints are applicable to numeric attributes, such as age, height and other attributes. The
 * constraints include conditions such as minimum value, maximum value, and interval openness or closure.
 */
