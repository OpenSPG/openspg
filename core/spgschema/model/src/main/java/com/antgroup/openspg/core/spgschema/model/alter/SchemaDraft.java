...
/**
 * The schema alternation of project ontologies. Every schema change must be based on the latest online version of the
 * schema. The schema draft contains the complete structure of the altered ontology, and will be submitted to the server
 * to perform the alter operation.
 */
