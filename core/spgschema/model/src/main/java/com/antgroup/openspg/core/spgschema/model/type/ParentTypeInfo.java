 ...
 * <br>
 * <p>Similar to object-oriented programming languages, there is an inheritance relationship between entities,
 * and each entity type has a parent class. Otherwise, it defaults to inheriting from "Thing", For example, the parent
 * class of humans is animals, the parent class of animals is organisms, and the parent class of organisms is
 * Thing.<br>
 * <br>
 * Under the SPG knowledge representation framework, subclasses will default to inheriting all attributes and semantic
 * relationships of the parent class.
 * <br>
 * For example, in the business of Ant Group, there are KouBeiShop and ElemeShop, and the properties of the two stores
 * are basically the same, represented by entity inheritance:
 * <ul>
 *     <li>(KouBeiShop subClassOf Shop)</li>
 *     <li>(ElemeShop subClassOf Shop)</li>
 * </ul>
 * </p>
 */
public class ParentTypeInfo extends BaseValObj {
    ...
    public static final ParentTypeInfo THING = new ParentTypeInfo(
        null, null,
        new SPGTypeIdentifier(null, SchemaConstants.ROOT_TYPE_UNIQUE_NAME),
        null
    );
    ...
    public ParentTypeInfo withNewParentInfo(Long uniqueId, Long parentUniqueId, List<Long> inheritPath) {
