...
public class SPGTypeMockFactory {
  ...
  public static EntityType mockThingType() {
    BasicInfo<SPGTypeIdentifier> basicInfo =
        new BasicInfo<>(SPGTypeIdentifier.parse(MockConstants.THING_TYPE_NAME), "事物", "desc");
    List<Property> propertys = PropertyMockFactory.mockThingProperty();
    EntityType entityType =
        new EntityType(basicInfo, null, propertys, null, new SPGTypeAdvancedConfig());
  ...
  public static StandardType mockStdType(String uniqueName, Long uniqueId) {
    BasicInfo<SPGTypeIdentifier> basicInfo =
        new BasicInfo<>(SPGTypeIdentifier.parse(uniqueName), "name", "desc");
    StandardType standardType =
        new StandardType(basicInfo, null, null, null, new SPGTypeAdvancedConfig(), true, null);
  ...
  public static EntityType mockEntityType() {
    ...
    ParentTypeInfo parentTypeInfo =
        new ParentTypeInfo(null, null, SPGTypeIdentifier.parse("Thing"), null);
    List<Property> propertys =
        mockProperties(MockConstants.ENTITY1_TYPE_NAME, MockConstants.ENTITY1_TYPE_ID);
    List<Relation> relations =
        mockRelations(
            MockConstants.ENTITY1_TYPE_NAME,
            MockConstants.ENTITY1_TYPE_ID,
            MockConstants.EVENT_TYPE_NAME,
            MockConstants.EVENT_TYPE_ID);
    SPGTypeAdvancedConfig advancedConfig = new SPGTypeAdvancedConfig();
    EntityType entityType =
        new EntityType(basicInfo, parentTypeInfo, propertys, relations, advancedConfig);
  ...
  public static ConceptType mockConceptType() {
    ...
    ParentTypeInfo parentTypeInfo =
        new ParentTypeInfo(null, null, SPGTypeIdentifier.parse("Thing"), null);
    List<Property> propertys =
        mockProperties(MockConstants.CONCEPT_TYPE_NAME, MockConstants.CONCEPT_TYPE_ID);
    List<Relation> relations =
        mockRelations(
            MockConstants.CONCEPT_TYPE_NAME,
  ...
  public static EventType mockEventType() {
    BasicInfo<SPGTypeIdentifier> basicInfo =
        new BasicInfo<>(SPGTypeIdentifier.parse(MockConstants.EVENT_TYPE_NAME), "测试事件", "desc");
    ParentTypeInfo parentTypeInfo =
        new ParentTypeInfo(null, null, SPGTypeIdentifier.parse("Thing"), null);
    ...
    SPGTypeAdvancedConfig advancedConfig = new SPGTypeAdvancedConfig();
    EventType eventType =
        new EventType(basicInfo, parentTypeInfo, propertys, relations, advancedConfig);
  ...
  public static EntityType mockEntityType(String uniqueName, Long uniqueId) {
    BasicInfo<SPGTypeIdentifier> basicInfo =
        new BasicInfo<>(SPGTypeIdentifier.parse(uniqueName), "测试", "desc");
    ParentTypeInfo parentTypeInfo =
        new ParentTypeInfo(null, null, SPGTypeIdentifier.parse("Thing"), null);
    SPGTypeAdvancedConfig advancedConfig = new SPGTypeAdvancedConfig();
  ...
  public static SPGTypeRef mockSpgTypeRef(String uniqueName, Long ontologyId) {
    BasicInfo<SPGTypeIdentifier> basicInfo =
        new BasicInfo<>(SPGTypeIdentifier.parse(uniqueName), "测试", "描述");
  ...
  public static SPGTypeRef mockTextTypeRef() {
    BasicInfo<SPGTypeIdentifier> basicInfo =
        new BasicInfo<>(SPGTypeIdentifier.parse(MockConstants.TEXT_TYPE_NAME), "文本", "描述");
  ...
  public static SPGTypeRef mockStdTypeRef() {
    BasicInfo<SPGTypeIdentifier> basicInfo =
        new BasicInfo<>(SPGTypeIdentifier.parse(MockConstants.PHONE_TYPE_NAME), "手机号", "描述");
  ...
  public static List<Property> mockEventProperties(String spgTypeName, Long ontologyId) {
    List<Property> propertys =
        PropertyMockFactory.mockEventBuiltInProperties(spgTypeName, ontologyId);
    ...
    propertys.add(
        PropertyMockFactory.mockEntityProperty(
            spgTypeName,
            ontologyId,
            MockConstants.ENTITY2_TYPE_NAME,
            MockConstants.ENTITY2_TYPE_ID));
    return propertys;
  }
  ...
  public static List<Relation> mockRelations(
