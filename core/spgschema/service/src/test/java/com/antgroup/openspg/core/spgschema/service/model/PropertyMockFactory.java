...
public class PropertyMockFactory {
  ...
  public static Property mockStandardProperty(String spgTypeName, Long ontologyId) {
    SPGTypeRef subjectTypeRef = SPGTypeMockFactory.mockSpgTypeRef(spgTypeName, ontologyId);
    BasicInfo<PredicateIdentifier> basicInfo =
        new BasicInfo<>(new PredicateIdentifier("mobile"), "手机", "desc mobile");
  ...
  public static Property mockConceptProperty(String spgTypeName, Long ontologyId) {
    SPGTypeRef subjectTypeRef = SPGTypeMockFactory.mockSpgTypeRef(spgTypeName, ontologyId);
    BasicInfo<PredicateIdentifier> basicInfo =
        new BasicInfo<>(new PredicateIdentifier("address"), "住址", "desc");
  ...
  public static List<Property> mockThingProperty() {
    SPGTypeRef subjectTypeRef =
        SPGTypeMockFactory.mockSpgTypeRef(
            MockConstants.THING_TYPE_NAME, MockConstants.THING_TYPE_ID);
    SPGTypeRef objectTypeRef = SPGTypeMockFactory.mockTextTypeRef();

    BasicInfo<PredicateIdentifier> idBasicInfo =
        new BasicInfo<>(new PredicateIdentifier("id"), "id", "desc id");
    Property idProp =
        new Property(
            idBasicInfo, subjectTypeRef, objectTypeRef, false, new PropertyAdvancedConfig());
    idProp.setProjectId(1L);
    idProp.setOntologyId(new OntologyId(MockConstants.ID_PROPERTY_ID));

    BasicInfo<PredicateIdentifier> nameBasicInfo =
        new BasicInfo<>(new PredicateIdentifier("name"), "name", "desc id");
    Property nameProp =
        new Property(
            nameBasicInfo, subjectTypeRef, objectTypeRef, false, new PropertyAdvancedConfig());
    nameProp.setProjectId(1L);
    nameProp.setOntologyId(new OntologyId(MockConstants.NAME_PROPERTY_ID));

    BasicInfo<PredicateIdentifier> descBasicInfo =
        new BasicInfo<>(new PredicateIdentifier("desc"), "desc", "desc id");
    Property descProp =
        new Property(
            descBasicInfo, subjectTypeRef, objectTypeRef, false, new PropertyAdvancedConfig());
  ...
  public static Property mockEntityProperty(
  ...
  public static List<Property> mockEventBuiltInProperties(String spgTypeName, Long ontologyId) {
    ...
    SPGTypeRef subjectTypeRef = SPGTypeMockFactory.mockSpgTypeRef(spgTypeName, ontologyId);
    BasicInfo<PredicateIdentifier> basicInfo =
        new BasicInfo<>(new PredicateIdentifier("eventTime"), "发生时间", "desc mobile");
    ...
    BasicInfo<PredicateIdentifier> subjectBasicInfo =
        new BasicInfo<>(new PredicateIdentifier("subject"), "主体", "desc mobile");
    SPGTypeRef subObjectTypeRef =
        new SPGTypeRef(
            new BasicInfo<>(SPGTypeIdentifier.parse(MockConstants.ENTITY1_TYPE_NAME), "主体", "desc"),
    ...
    Property subject =
        new Property(subjectBasicInfo, subjectTypeRef, subObjectTypeRef, false, subAdvancedConfig);
    subject.setAlterOperation(AlterOperationEnum.CREATE);
    propertys.add(subject);

    BasicInfo<PredicateIdentifier> objBasicInfo =
        new BasicInfo<>(new PredicateIdentifier("objectWho"), "客体", "desc mobile");
    SPGTypeRef objObjectTypeRef =
        new SPGTypeRef(
            new BasicInfo<>(SPGTypeIdentifier.parse(MockConstants.CONCEPT_TYPE_NAME), "客体", "desc"),
    ...
    Property obj =
        new Property(objBasicInfo, subjectTypeRef, objObjectTypeRef, false, objAdvancedConfig);
