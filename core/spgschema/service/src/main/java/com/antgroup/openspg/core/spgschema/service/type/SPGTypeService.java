...
/**
 * The interface of spg type that provides create、update、delete、query method to manager the spg types, as spg type
 * contains properties and relations, it will alter its properties and relations at same time when altering spg type.
 * Also, the interface provides multi methods to query spg types, such as query by unique name、id, or query the whole
 * types in a project.
 */
public interface SPGTypeService {
    ...
    /**
     * Update the type config, such as CRUD its property or relation, forbid to update the name of type.
     *
