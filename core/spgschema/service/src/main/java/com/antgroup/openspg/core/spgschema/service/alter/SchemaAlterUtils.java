...
public class SchemaAlterUtils {
     ...
     * @return
     */
    public static List<BaseSPGType> merge(List<BaseSPGType> onlineSchema, List<BaseAdvancedType> alterSchema) {
        List<BaseSPGType> newSchema = new ArrayList<>();
        Map<SPGTypeIdentifier, BaseSPGType> alterMap = alterSchema.stream()
    ...
    public static List<BaseAdvancedType> sortByInheritPath(List<BaseSPGType> advancedTypes) {
        final Map<SPGTypeIdentifier, BaseAdvancedType> advancedTypeAggMap = advancedTypes.stream()
        ...
        advancedTypeAggMap.values().forEach(advancedType -> {
            ...
            while (true) {
                ...
                BaseAdvancedType parent = advancedTypeAggMap
                    .get(advancedType.getParentTypeInfo().getParentTypeIdentifier());
                if (parent != null) {
                    stack.push(parent);
                    advancedType = parent;
                } else {
     ...
     * @return spg type
     */
    public static BaseAdvancedType findSpgType(List<BaseAdvancedType> spgTypes, SPGTypeIdentifier spgTypeName) {
