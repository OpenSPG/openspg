...
public interface SemanticRepository {
     ...
     * @return record count
     */
    int deleteBySpo(String subjectId, String predicateName, String objectId, SPGOntologyEnum ontologyEnum);
     ...
     * @return record count
     */
    int deleteByObject(String predicateName, String objectType, String objectId, SPGOntologyEnum ontologyEnum);
