...
/**
 * Default property enums of spg type, currently only ConceptType has default property, the default property is created
 * by system when the spg type is created, and deleted by system when the spg type is deleted.
 */
public enum BuiltInPropertyEnum {
     ...
     */
    STD_ID("CONCEPT_TYPE", "stdId", "标准ID", "标准ID",
        false, "Text", "BASIC_TYPE", null),

    /**
     * Alias of concept, such as capital of BeiJing city.
     */
    ALIAS("CONCEPT_TYPE", "alias", "别名", "别名",
        true, "Text", "BASIC_TYPE", null),

    /**
     * Time that event occurs, the format of value must be unix timestamp.
     */
    EVENT_TIME("EVENT_TYPE", "eventTime", "发生时间", "发生时间",
        false, "STD.Timestamp", "STANDARD_TYPE", "TIME"),
    ;
    ...
    BuiltInPropertyEnum(
        String spgTypeEnum, String name, String nameZh,
        String desc, boolean multiValue, String valueType,
        String valueTypeEnum, String propertyGroup) {
