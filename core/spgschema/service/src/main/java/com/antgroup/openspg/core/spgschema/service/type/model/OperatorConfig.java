...
/**
 * The operator config of a spg type, for example, an EntityType will have a linking operator and a fusing operator, and
 * a ConceptType will have a fusing operator and a normalizing operator.
 */
