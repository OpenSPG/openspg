...
public class GraphLoaderConfigTest {
    ...
    public void testMerge() {
        ...
        vertexLoaderConfig2
            .setNeedProperties(new HashSet<>(Arrays.asList(new String[] { "name" })));
        ...
        Assert.assertTrue(config.getVertexLoaderConfigs().iterator().next().getNeedProperties()
            .equals(new HashSet<>(Arrays.asList(new String[] { "id", "name" }))));
        Assert.assertTrue(config.getEdgeLoaderConfigs().iterator().next().getNeedProperties()
                .equals(new HashSet<>(Arrays.asList(new String[] { "id", "name" }))));
    }
