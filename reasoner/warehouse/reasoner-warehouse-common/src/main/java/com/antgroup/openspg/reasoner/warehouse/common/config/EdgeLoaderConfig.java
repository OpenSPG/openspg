...
public class EdgeLoaderConfig implements Serializable {
    ...
    /**
     * connection info for this edge type
     * considering that each edge may be stored in different storage or different table
     */
    ...
    public EdgeLoaderConfig merge(EdgeLoaderConfig other) {
        ...
        } else if (Direction.IN.equals(this.loadDirection) && Direction.OUT.equals(other.loadDirection)) {
            newLoadDirection = Direction.BOTH;
        } else if (Direction.OUT.equals(this.loadDirection) && Direction.IN.equals(other.loadDirection)) {
            newLoadDirection = Direction.BOTH;
        } else {
    ...
    public String toString() {
        return "EdgeLoaderConfig,edgeType=" + this.edgeType + ",edgeTruncateThreshold=" + this.edgeTruncateThreshold + ",connection="
                + this.connection + ",needProperties=" + this.needProperties + ",propertiesFilterRuleString="
                + this.getPropertiesFilterRuleString() + ",loadDirection=" + this.getLoadDirection();
    }
}
