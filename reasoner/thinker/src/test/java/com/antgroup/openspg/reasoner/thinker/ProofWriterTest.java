...
public class ProofWriterTest {
  ...
  public void testCase5() {
    Thinker thinker = buildThinker("/ProofWriter5.txt");
    Map<String, Object> context = new HashMap<>();
    Triple t1 = makeTriple("dog", "Thing", "iss", "green");
    Triple t2 = makeTriple("lion", "Thing", "iss", "big");
    Triple t3 = makeTriple("lion", "Thing", "iss", "round");
    Triple t4 = makeTriple("lion", "Thing", "needs", "dog", "Thing");
    Triple t5 = makeTriple("mouse", "Thing", "iss", "big");
    Triple t6 = makeTriple("mouse", "Thing", "likes", "dog", "Thing");
    Triple t7 = makeTriple("mouse", "Thing", "visits", "dog", "Thing");
    Triple t8 = makeTriple("rabbit", "Thing", "iss", "Thing");
    Triple t9 = makeTriple("rabbit", "Thing", "visits", "dog", "Thing");
    List<Triple> triples = Arrays.asList(t1, t2, t3, t4, t5, t6, t7, t8, t9);
    triples.forEach(t -> context.put(t.toString(), t));
    List<Result> result =
        thinker.find(
            new Entity("mouse", "Thing"),
            new Predicate("needs"),
            new Entity("dog", "Thing"),
            context);
    Assert.assertTrue(result.size() == 1);
  }
  ...
  public void testCase6() {
    Thinker thinker = buildThinker("/ProofWriter6.txt");
    Map<String, Object> context = new HashMap<>();
    Triple t1 = makeTriple("Charlie", "Thing", "iss", "big");
    Triple t2 = makeTriple("Charlie", "Thing", "iss", "cold");
    Triple t3 = makeTriple("Charlie", "Thing", "iss", "kind");
    Triple t4 = makeTriple("Charlie", "Thing", "iss", "quiet");
    Triple t5 = makeTriple("Charlie", "Thing", "iss", "red");
    Triple t6 = makeTriple("Charlie", "Thing", "iss", "rough");
    Triple t7 = makeTriple("Charlie", "Thing", "iss", "smart");
    Triple t8 = makeTriple("Erin", "Thing", "iss", "kind");
    Triple t9 = makeTriple("Fiona", "Thing", "iss", "quiet");
    Triple t10 = makeTriple("Fiona", "Thing", "iss", "rough");
    Triple t11 = makeTriple("Harry", "Thing", "iss", "kind");
    Triple t12 = makeTriple("Harry", "Thing", "iss", "rough");
    List<Triple> triples = Arrays.asList(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12);
    triples.forEach(t -> context.put(t.toString(), t));
    List<Result> result =
  ...
  public void testCase8() {
    ...
    triples.forEach(t -> context.put(t.toString(), t));
    List<Result> result =
        thinker.find(new Entity("Erin", "Thing"), new Predicate("iss"), new Node("furry"), context);
    Assert.assertTrue(result.size() == 1);
  }
}
