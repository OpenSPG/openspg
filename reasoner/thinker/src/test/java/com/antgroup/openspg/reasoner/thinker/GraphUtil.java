...
public class GraphUtil {
    public static Edge<IVertexId, IVersionProperty> makeEdge(Vertex<IVertexId, IProperty> from,
                                                             Vertex<IVertexId, IProperty> to,
                                                             String edgeType, Object... kvs) {
        ...
        return new Edge<>(from.getId(), to.getId(), new VertexVersionProperty(props), 0L,
    ...
    public static MemGraphState buildMemState(List<IVertex<IVertexId, IProperty>> vertexList,
