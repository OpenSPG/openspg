...
public class SplitToWorkerIndexTest {
    ...
    public void testSimpleSplit() {
        ...
        Map<Integer, KgGraph<IVertexId>> splitMap = kgGraph.splitToWorkerIndex("A", new IVertexId2WorkerIndex() {
            @Override
        ...
        }, schema, new KgGraphSplitStaticParameters(Sets.newHashSet("A"), schema), null, null);
    ...
    public void testSimpleSplit2() {
        ...
        int countPath = 0;
        Iterator<KgGraph<IVertexId>> pathIt = splitMap.get(0).getPath(new KgGraphSplitStaticParameters(null, schema), null);
    ...
    public void testSplit3() {
        ...
        Map<Integer, KgGraph<IVertexId>> splitMap = kgGraph.splitToWorkerIndex("C", new IVertexId2WorkerIndex() {
            @Override
            public int workerIndex(IVertexId vertexId) {
                return 0;
            }
        }, schema, new KgGraphSplitStaticParameters(Sets.newHashSet("C"), schema), null, null);
    ...
    public void testSimpleSplit4() {
        ...
        Map<Integer, KgGraph<IVertexId>> splitMap = kgGraph.splitToWorkerIndex("B", new IVertexId2WorkerIndex() {
            @Override
            public int workerIndex(IVertexId vertexId) {
        ...
        Assert.assertEquals(2, splitMap.size());
        splitMap.forEach(new BiConsumer<Integer, KgGraph<IVertexId>>() {
            @Override
            public void accept(Integer integer, KgGraph<IVertexId> iVertexIdKgGraph) {
                ...
                int countPath = 0;
                Iterator<KgGraph<IVertexId>> pathIt = iVertexIdKgGraph.getPath(new KgGraphSplitStaticParameters(null, schema), null);
                while (pathIt.hasNext()) {
                    KgGraph<IVertexId> path = pathIt.next();
                    if (null == path) {
                        continue;
        ...
        Map<Integer, KgGraph<IVertexId>> splitMap2 = kgGraph.splitToWorkerIndex("D", new IVertexId2WorkerIndex() {
            @Override
            public int workerIndex(IVertexId vertexId) {
        ...
        }, schema, new KgGraphSplitStaticParameters(Sets.newHashSet("D"), schema), null, null);

        Assert.assertEquals(2, splitMap2.size());
        splitMap2.forEach(new BiConsumer<Integer, KgGraph<IVertexId>>() {
            @Override
            public void accept(Integer integer, KgGraph<IVertexId> iVertexIdKgGraph) {
    ...
    public void testSplit5() {
        ...
        Map<Integer, KgGraph<IVertexId>> splitMap = kgGraph.splitToWorkerIndex("A",
                new IVertexId2WorkerIndex() {
                    @Override
                    public int workerIndex(IVertexId vertexId) {
                        return 0;
                    }
                }, schema, new KgGraphSplitStaticParameters(Sets.newHashSet("A"), schema),
    ...
    public void testSplit6() {
        ...
        Map<Integer, KgGraph<IVertexId>> splitMap = kgGraph.splitToWorkerIndex("B",
                new IVertexId2WorkerIndex() {
                    @Override
                    public int workerIndex(IVertexId vertexId) {
                        if (21L == vertexId.getInternalId()) {
                ...
                }, schema, new KgGraphSplitStaticParameters(Sets.newHashSet("B"), schema),
                new Predicate<KgGraph<IVertexId>>() {
                    @Override
                    public boolean test(KgGraph<IVertexId> iVertexIdKgGraph) {
                        return true;
        ...
        kgGraph.getAlias2EdgeMap().get("E3").add(
                new Edge(IVertexId.from(22, DEFAULT_VERTEX_TYPE), IVertexId.from(31, DEFAULT_VERTEX_TYPE), null, 0L,
                        Direction.OUT, "E3T"));

        Map<Integer, KgGraph<IVertexId>> splitMap2 = kgGraph.splitToWorkerIndex("B",
                new IVertexId2WorkerIndex() {
                    @Override
                    public int workerIndex(IVertexId vertexId) {
                        if (21L == vertexId.getInternalId()) {
        ...
        kgGraph.getAlias2VertexMap().get("B").add(new Vertex<>(IVertexId.from(23, DEFAULT_VERTEX_TYPE), null));
        kgGraph.getAlias2EdgeMap().get("E3").add(
                new Edge(IVertexId.from(23, DEFAULT_VERTEX_TYPE), IVertexId.from(31, DEFAULT_VERTEX_TYPE), null, 0L,
                        Direction.OUT, "E3T"));

        kgGraph.getAlias2EdgeMap().get("E1").add(
                new Edge(IVertexId.from(11, DEFAULT_VERTEX_TYPE), IVertexId.from(23, DEFAULT_VERTEX_TYPE), null, 0L,
                        Direction.OUT, "E1T"));

        Map<Integer, KgGraph<IVertexId>> splitMap3 = kgGraph.splitToWorkerIndex("B",
                new IVertexId2WorkerIndex() {
                    @Override
                    public int workerIndex(IVertexId vertexId) {
                        if (21L == vertexId.getInternalId()) {
        ...
        Map<Integer, KgGraph<IVertexId>> splitMap4 = kgGraph.splitToWorkerIndex("B",
                new IVertexId2WorkerIndex() {
                    @Override
                    public int workerIndex(IVertexId vertexId) {
                        if (21L == vertexId.getInternalId()) {
                ...
                }, schema, new KgGraphSplitStaticParameters(Sets.newHashSet("B"), schema), null, null);
