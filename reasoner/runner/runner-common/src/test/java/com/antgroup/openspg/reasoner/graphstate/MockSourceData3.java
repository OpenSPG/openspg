...
public class MockSourceData3 extends LoadSourceData {
    ...
    public Map<String, Set<IVertex<IVertexId, IProperty>>> loadAlias2Vertex() {
        {
            ...
            alias2VertexMap.put("C", new HashSet() {{
                add(c1);
                add(c2);
            }});
            alias2VertexMap.put("B", new HashSet() {{add(b1);}});
    ...
    public Map<String, Set<IEdge<IVertexId, IProperty>>> loadAlias2Edge() {
        ...
        Edge ab1 = new Edge(IVertexId.from("a1", DEFAULT_VERTEX_TYPE), IVertexId.from("b1", DEFAULT_VERTEX_TYPE), property1, 0L,
                Direction.OUT, "directFilm");
        IProperty property2 = new EdgeProperty();
        Edge ab2 = new Edge(IVertexId.from("a2", DEFAULT_VERTEX_TYPE), IVertexId.from("b1", DEFAULT_VERTEX_TYPE), property2, 0L,
                Direction.OUT, "directFilm");
        IProperty property3 = new EdgeProperty();
        Edge bc1 = new Edge(IVertexId.from("b1", DEFAULT_VERTEX_TYPE), IVertexId.from("c1", DEFAULT_VERTEX_TYPE), property3, 0L,
                Direction.OUT, "workmates");
        IProperty property4 = new EdgeProperty();
        Edge bc2 = new Edge(IVertexId.from("b1", DEFAULT_VERTEX_TYPE), IVertexId.from("c2", DEFAULT_VERTEX_TYPE), property4, 0L,
                Direction.OUT, "workmates");
        IProperty property5 = new EdgeProperty();
        Edge ac1 = new Edge(IVertexId.from("a1", DEFAULT_VERTEX_TYPE), IVertexId.from("c2", DEFAULT_VERTEX_TYPE), property5, 0L,
                Direction.OUT, "writerOfFilm");
        IProperty property6 = new EdgeProperty();
        Edge ac2 = new Edge(IVertexId.from("a2", DEFAULT_VERTEX_TYPE), IVertexId.from("c1", DEFAULT_VERTEX_TYPE), property6, 0L,
                Direction.OUT, "writerOfFilm");

        alias2EdgeMap.put("E1", new HashSet() {{
            add(ab1);
            add(ab2);
        }});
        alias2EdgeMap.put("E2", new HashSet() {{
            add(ac1);
            add(ac2);
        }});
        alias2EdgeMap.put("E3", new HashSet() {{
            add(bc1);
            add(bc2);
        }});
    ...
    public Pattern loadPattern() {
        ...
        PatternConnection B_C = new PatternConnection("E3", B.alias(), null, C.alias(), Direction.OUT, null, null, true, false);
        PatternConnection A_B = new PatternConnection("E1", A.alias(), null, B.alias(), Direction.OUT, null, null, true, false);
        PatternConnection A_C = new PatternConnection("E2", A.alias(), null, C.alias(), Direction.OUT, null, null, true, false);
