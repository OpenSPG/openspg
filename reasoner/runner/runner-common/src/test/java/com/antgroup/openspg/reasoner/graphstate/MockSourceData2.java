...
public class MockSourceData2 extends LoadSourceData {
  ...
  */
  ...
  public Map<String, Set<IEdge<IVertexId, IProperty>>> loadAlias2Edge() {
    ...
    Edge bc1 =
        new Edge(
            IVertexId.from("b1", "NULL"),
            IVertexId.from("c1", "NULL"),
            null,
            0L,
            Direction.OUT,
            "E");
  ...
  public Pattern loadPattern() {
    ...
    PatternConnection B_C =
        new PatternConnection(
            "B_C", B.alias(), null, C.alias(), Direction.OUT, null, -1, true, false);
    PatternConnection A_B =
        new PatternConnection(
            "A_B", A.alias(), null, B.alias(), Direction.OUT, null, -1, true, false);
