...
public class ContextManagementTest {
  ...
  public void testJobConfigMap() {
    ...
    TaskRecord taskRecord =
        TaskRecord.builder().params(paramsMap).initializerClassList(initializerClassList).build();
    ...
    DispatchContextInfo dispatchContextInfo =
        ContextManagement.getInstance().getDispatchContextInfo();
