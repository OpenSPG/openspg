...
public class KgGraphSimpleSplitTest {
  ...
  public void testNotNeedSplit() {
    ...
    List<KgGraph<IVertexId>> rst2 =
        kgGraph.split(
            ...
            schema,
            new KgGraphSplitStaticParameters(splitVertexAliasSet2, schema),
            null,
            null);
  ...
  public void testSampleSplit2() {
    ...
    kgGraph
        ...
        .add(
            new Edge(
                IVertexId.from(13, DEFAULT_VERTEX_TYPE),
    ...
    kgGraph
        ...
        .add(
            new Edge(
                IVertexId.from(14, DEFAULT_VERTEX_TYPE),
                IVertexId.from(22, DEFAULT_VERTEX_TYPE),
                null,
                0L,
                Direction.OUT,
    ...
    List<KgGraph<IVertexId>> rst4 =
        kgGraph.split(
            splitVertexAliasSet4,
            schema,
            new KgGraphSplitStaticParameters(splitVertexAliasSet4, schema),
            null,
            null);
        ...
        .forEach(
            iVertexIdKgGraph -> {
              ...
              Assert.assertEquals(
                  ...
                  iVertexIdKgGraph.getVertex("B").get(0).getId());
            });
  }
  ...
  public static Pattern pattern1() {
    ...
    Connection A_B =
        new PatternConnection(
            "E1", A.alias(), null, B.alias(), Direction.OUT, null, -1, true, false);
    Connection B_C =
        new PatternConnection(
            "E2", B.alias(), null, C.alias(), Direction.OUT, null, -1, true, false);
    Connection C_D =
        new PatternConnection(
            "E3", C.alias(), null, D.alias(), Direction.OUT, null, -1, true, false);
  ...
  public static Pattern pattern2() {
    ...
    PatternConnection B_C =
        new PatternConnection(
            "E2", B.alias(), null, C.alias(), Direction.OUT, null, -1, true, false);
    PatternConnection C_D =
        new PatternConnection(
            "E3", C.alias(), null, D.alias(), Direction.OUT, null, -1, true, false);
    PatternConnection D_A =
        new PatternConnection(
            "E4", D.alias(), null, A.alias(), Direction.OUT, null, -1, true, false);
  ...
  public static Pattern pattern3() {
    ...
    PatternConnection A_C =
        new PatternConnection(
            "E2", A.alias(), null, C.alias(), Direction.OUT, null, -1, true, false);
    PatternConnection B_C =
        new PatternConnection(
            "E3", B.alias(), null, C.alias(), Direction.OUT, null, -1, true, false);
  ...
  public static KgGraphImpl kgGraph1() {
    ...
    kgGraph
        .getAlias2VertexMap()
        .put("B", Sets.newHashSet(new Vertex<>(IVertexId.from(21, DEFAULT_VERTEX_TYPE), null)));
    kgGraph
        .getAlias2VertexMap()
        .put("C", Sets.newHashSet(new Vertex<>(IVertexId.from(31, DEFAULT_VERTEX_TYPE), null)));
    kgGraph
        .getAlias2VertexMap()
        .put("D", Sets.newHashSet(new Vertex<>(IVertexId.from(41, DEFAULT_VERTEX_TYPE), null)));
  ...
  public static KgGraphImpl kgGraph2() {
    ...
    kgGraph
        .getAlias2VertexMap()
        .put("A", Sets.newHashSet(new Vertex<>(IVertexId.from(11, DEFAULT_VERTEX_TYPE), null)));
    kgGraph
        .getAlias2VertexMap()
        .put("B", Sets.newHashSet(new Vertex<>(IVertexId.from(21, DEFAULT_VERTEX_TYPE), null)));
    kgGraph
