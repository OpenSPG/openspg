...
public class HiveWriterSession {
     ...
     */
    public void commit() {
        initConnection(this.hiveTableInfo.getJdbcUrl(), this.hiveTableInfo.getJdbcUser(), this.hiveTableInfo.getJdbcPasswd());
    ...
    private boolean checkHdfsDataExist(HiveTableInfo hiveTableInfo) {
        Triple<String, String, List<String>> outputPathPair = HiveUtils.getHdfsOutputPath(hiveTableInfo);
    ...
    private String getHiveDataPath(HiveTableInfo hiveTableInfo) {
        Triple<String, String, List<String>> outputPathTriple = HiveUtils.getHdfsOutputPath(hiveTableInfo);
