...
public class ConfigKey {
     ...
     * source function
     */
    public static final String KG_REASONER_STREAMING_SOURCE_FUNCTION = "kg.reasoner.streaming.source.function";
     ...
     */
    public static final String KG_REASONER_GRAPH_KGSTATE_CONNECTION = "kg.reasoner.graph.load.kgstate.connection";

    /**
     * set kgstate schema url
     */
    public static final String KG_REASONER_GRAPH_KGSTATE_SCHEMA_URL = "kg.reasoner.graph.load.kgstate.schema.url";

    /**
     * enable cache project
     */
    public static final String KG_REASONER_PLAN_CACHE_PROJECT_ENABLE = "kg.reasoner.plan_cache_project_enable";
    ...
    /**
     * max path limit
     * use __max_path_size__ compatible with 1.0
     */
    public static final String KG_REASONER_MAX_PATH_LIMIT = "__max_path_size__";

    /**
     * max path limit, exceeding threshold will throw an exception
     * only for local runner
     */
    public static final String KG_REASONER_STRICT_MAX_PATH_THRESHOLD = "kg.reasoner.strict.path.threshold";

    /**
     * edge limit for one vertex
     * use __max_edge_size__ compatible with 1.0
     */
     ...
     */
    public static final String KG_REASONER_INITIALIZER_CLASS_LIST = "kg.reasoner.initializer.class.list";
     ...
     */
    public static final String KG_REASONER_EXTRA_GRAPH_LOAD_CONFIG = "kg.reasoner.extra.graph.load.config";
