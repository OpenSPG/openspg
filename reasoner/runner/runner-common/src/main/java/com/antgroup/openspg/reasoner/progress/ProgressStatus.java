...
public class ProgressStatus implements Serializable {
    ...
    static public ProgressStatus getProgressStatusFromOSS(String taskKey) {
        try {
    ...
    public void persistenceProgressStatus() {
        log.info(
                "persistenceProgressStatus: storage is " + this.persistenceWay + " " + this.toJson());
    ...
    public void updateProgress(long batchId, long readOffset, long processOffset) {
        ...
        if (this.progressInfo.getProcessOffset() > this.progressInfo.getTotal()) {
            log.warn("ProgressStatus::updateProgress ProcessOffset("
                    + this.progressInfo.getProcessOffset() + ") > Total("
