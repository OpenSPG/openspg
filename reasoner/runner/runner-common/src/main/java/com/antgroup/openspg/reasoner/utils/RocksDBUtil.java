...
public class RocksDBUtil {
    ...
    /**
     * construct vertex key on rocksdb
     * V_w_id_fill_W
     * @param vertexId
     * @return
     */
     ...
     * @return
     */
    public static byte[] buildRocksDBEdgeKeyWithoutWindow(String edgeType, Direction direction, IVertexId vertexId) {
