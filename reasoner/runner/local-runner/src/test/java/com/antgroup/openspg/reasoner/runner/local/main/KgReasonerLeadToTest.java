...
public class KgReasonerLeadToTest {
  ...
  public void addVertexTest1() {
    ...
    task.setGraphLoadClass(
        "com.antgroup.openspg.reasoner.runner.local.main.KgReasonerLeadToTest$GraphLoaderForAddVertex");
  ...
  public void leadToTest1() {
    ...
    task.setGraphLoadClass(
        "com.antgroup.openspg.reasoner.runner.local.main.KgReasonerLeadToTest$GraphLoader");
