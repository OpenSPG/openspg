...
public class LocalOptionalTest {
  ...
  public void doTestOptional4() {
    ...
    task.setGraphLoadClass(
        "com.antgroup.openspg.reasoner.local.main.LocalOptionalTest$MedicalGraphLoader3");
  ...
  public void doTestOptional5() {
    ...
    task.setDsl(dsl);
    task.setGraphLoadClass(
        "com.antgroup.openspg.reasoner.local.main.LocalOptionalTest$MedicalGraphLoader5");
  ...
  public void doTestOptional2() {
    ...
    task.setDsl(dsl);
    task.setGraphLoadClass(
        "com.antgroup.openspg.reasoner.local.main.LocalOptionalTest$MedicalGraphLoader2");
  ...
  public void doTestOptional01() {
    ...
    LocalReasonerTask task = new LocalReasonerTask();
    task.setDsl(dsl);
    task.setGraphLoadClass("com.antgroup.openspg.reasoner.local.loader.MedicalGraphLoader");
