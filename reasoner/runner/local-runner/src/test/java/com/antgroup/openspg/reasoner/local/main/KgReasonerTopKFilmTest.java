...
import com.antgroup.openspg.reasoner.local.main.basetest.FilmBaseTestData;
...
public class KgReasonerTopKFilmTest {
  ...
  private List<String[]> runTestResult(String dsl) {
    return FilmBaseTestData.runTestResult(
        dsl,
        "com.antgroup.openspg.reasoner.local.main.basetest.FilmBaseTestData$FilmGraphGeneratorTopK");
  }
