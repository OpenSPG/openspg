...
public class LocalRunnerTest {
  ...
  public void doTestAvg2() {
    ...
    task.setDsl(dsl);
    task.setGraphLoadClass("com.antgroup.openspg.reasoner.local.loader.TestFundGraphLoader");
  ...
  public void doTestLocalRunnerDependency() {
    ...
    LocalReasonerTask task = new LocalReasonerTask();
    task.setDsl(dsl);
    task.setGraphLoadClass("com.antgroup.openspg.reasoner.local.loader.TestCrowdGraphLoader");
  ...
  public void testComplexMultiDefineDsl() {
    ...
    task.setGraphLoadClass(
        "com.antgroup.openspg.reasoner.local.loader.TestMultiVersionGraphLoader");
  ...
  public void testEdgePropertyDefineDsl2() {
    ...
    LocalReasonerTask task = new LocalReasonerTask();
    task.setDsl(dsl);
    task.setGraphLoadClass("com.antgroup.openspg.reasoner.local.loader.TestInsProductGraphLoader");
  ...
  public void doTestComplexDefineDsl() {
    ...
    LocalReasonerTask task = new LocalReasonerTask();
    task.setDsl(dsl);
    task.setGraphLoadClass("com.antgroup.openspg.reasoner.local.loader.TestDefineGraphLoader");
  ...
  public void doTestComplexLabelDsl() {
    ...
    LocalReasonerTask task = new LocalReasonerTask();
    task.setDsl(dsl);
    task.setGraphLoadClass("com.antgroup.openspg.reasoner.local.loader.TestMultiLabelGraphLoader");
  ...
  public void doTestSpatioTemporalDsl() {
    ...
    task.setGraphLoadClass(
        "com.antgroup.openspg.reasoner.local.loader.TestSpatioTemporalGraphLoader");
