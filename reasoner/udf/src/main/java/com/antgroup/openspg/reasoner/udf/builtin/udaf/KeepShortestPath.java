...
@UdfDefine(name = "keep_shortest_path", compatibleName = "KeepShortestPath")
public class KeepShortestPath implements BaseUdaf {
  private Object shortestPath = null;
  ...
  public void update(Object row) {
    if (null == shortestPath) {
      this.shortestPath = row;
    } else {
      this.shortestPath = shorterPath(this.shortestPath, row);
    }
  }

  private Object shorterPath(Object o1, Object o2) {
    int len1 = 0;
    int len2 = 0;
  ...
  public void merge(BaseUdaf function) {
    this.shortestPath = shorterPath(this.shortestPath, function);
  }
