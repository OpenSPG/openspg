...
class SubProperty(object):
    ...
    def __init__(self, basic_info=None, subject_type_ref=None, object_type_ref=None, advanced_config=None,
                 project_id=None, ontology_id=None, alter_operation=None, ext_info=None,
