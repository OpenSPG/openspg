...
class PropertyRef(object):
    ...
    def __init__(self, subject_type_ref=None, basic_info=None, object_type_ref=None, advanced_config=None,
                 ontology_enum=None, project_id=None, ontology_id=None, alter_operation=None, ext_info=None,
