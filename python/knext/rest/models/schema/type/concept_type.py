...
class ConceptType(object):
    ...
    def __init__(self, basic_info=None, parent_type_info=None, spg_type_enum='CONCEPT_TYPE', properties=None,
                 relations=None, advanced_config=None, project_id=None, ontology_id=None, alter_operation=None,
                 ext_info=None, concept_layer_config=None, concept_taxonomic_config=None,
                 concept_multi_version_config=None, local_vars_configuration=None):  # noqa: E501
