...
class BuilderJobInst(object):
    ...
    def __init__(self, job_inst_id=None, job_id=None, project_id=None, status=None, start_time=None, end_time=None,
                 result=None, progress=None, log_info=None, external_job_inst_id=None,
