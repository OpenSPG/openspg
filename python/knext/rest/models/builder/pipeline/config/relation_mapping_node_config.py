...
class RelationMappingNodeConfig(object):
    ...
    def __init__(self, type='RELATION_MAPPING', relation=None, mapping_filters=None, mapping_configs=None, predicting_configs=None, local_vars_configuration=None):  # noqa: E501
