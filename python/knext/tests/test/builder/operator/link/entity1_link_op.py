...
class Entity1LinkOp(LinkOp):
    ...
    def invoke(self, property: str, subject_record: SPGRecord) -> List[SPGRecord]:
        print("####################Entity1LinkOp#####################")
        print("Entity1LinkOp(Input): ")
        print("--------------------------------------------")
        print(f"property: {property}, subject_record: {subject_record}")

        linked_record = self.search_client.exact_search_by_property(property, TEST.Entity1.id)

        print("Entity1LinkOp(Output): ")
        print("--------------------------------------------")
        print([linked_record])
