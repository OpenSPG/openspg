...
class Concept2LinkOp(LinkOp):
    ...
    def invoke(self, property: str, subject_record: SPGRecord) -> List[SPGRecord]:
        print("####################Concept2LinkOp#####################")
        print("Concept2LinkOp(Input): ")
        print("--------------------------------------------")
        print(f"property: {property}, subject_record: {subject_record}")

        linked_record = self.search_client.exact_search_by_property(property, TEST.Concept2.id)

        print("Concept2LinkOp(Output): ")
        print("--------------------------------------------")
        print([linked_record])
