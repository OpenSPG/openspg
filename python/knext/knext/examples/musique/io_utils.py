...
def generate_submission_file(output_file_path, musique_dataset, agent_results):
    ...
    with open(output_file_path, 'w') as f:
        for question in tqdm(musique_dataset.get_all_questions(), desc='Writing Into Submission File'):
            line_dict = {}
            line_dict['id'] = musique_dataset.get_id_by_question(question)
            line_dict['predicted_answer'] = question_agent_result_dict[question]['predicted_answer']
            line_dict['predicted_support_idxs'] = question_agent_result_dict[question]['predicted_support_idxs']
