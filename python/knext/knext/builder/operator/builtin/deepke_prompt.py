...
class DeepKE_NERPrompt(DeepKEPrompt):
...
class DeepKE_SPOPrompt(DeepKEPrompt):
...
class DeepKE_REPrompt(DeepKE_SPOPrompt):
...
class DeepKE_KGPrompt(DeepKEPrompt):
...
class DeepKE_EEPrompt(DeepKEPrompt):
