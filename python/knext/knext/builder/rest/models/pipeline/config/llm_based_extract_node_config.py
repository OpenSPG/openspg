...
class LlmBasedExtractNodeConfig(object):
    ...
    @property
    def type(self):
        """Gets the type of this LlmBasedExtractNodeConfig.  # noqa: E501


        :return: The type of this LlmBasedExtractNodeConfig.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this LlmBasedExtractNodeConfig.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LlmBasedExtractNodeConfig):
            return False
