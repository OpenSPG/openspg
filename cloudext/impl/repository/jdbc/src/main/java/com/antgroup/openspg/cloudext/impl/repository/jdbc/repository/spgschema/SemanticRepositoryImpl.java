...
public class SemanticRepositoryImpl implements SemanticRepository {
    ...
    @Autowired
    private SemanticDOMapper semanticDOMapper;
    ...
    @Override
    public int deleteBySpo(String subjectId, String predicateName, String objectId, SPGOntologyEnum ontologyEnum) {
        SemanticDOExample example = new SemanticDOExample();
    ...
    @Override
    public int deleteByObject(String predicateName, String objectType, String objectId, SPGOntologyEnum ontologyEnum) {
        SemanticDOExample example = new SemanticDOExample();
        SemanticDOExample.Criteria criteria = example.createCriteria();
        if (predicateName != null) {
            criteria.andSemanticTypeEqualTo(predicateName);
    ...
    @Override
    public List<SimpleSemantic> queryBySubjectId(List<String> subjectIds, SPGOntologyEnum ontologyEnum) {
        SemanticDOExample example = new SemanticDOExample();
        example.createCriteria()
