...
public interface DataSourceUsageDOMapper {
    ...
    int updateByExampleSelective(@Param("record") DataSourceUsageDO record, @Param("example") DataSourceUsageDOExample example);

    int updateByExample(@Param("record") DataSourceUsageDO record, @Param("example") DataSourceUsageDOExample example);
