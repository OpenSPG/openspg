...
public class OperatorRepositoryImpl implements OperatorRepository {
    ...
    @Autowired
    private OperatorOverviewDOMapper operatorOverviewDOMapper;

    @Autowired
    private OperatorVersionDOMapper operatorVersionDOMapper;
    ...
    public OperatorOverview query(Long overviewId) {
        ...
        List<OperatorOverviewDO> operatorOverviewDOS = operatorOverviewDOMapper.selectByExample(example);
    ...
    public List<OperatorVersion> batchQuery(Long overviewId, List<Integer> versions) {
        ...
        example.createCriteria()
            .andOverviewIdEqualTo(overviewId)
