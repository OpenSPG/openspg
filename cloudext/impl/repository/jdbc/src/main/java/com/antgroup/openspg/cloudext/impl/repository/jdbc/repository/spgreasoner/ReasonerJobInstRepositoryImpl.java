...
package com.antgroup.openspg.cloudext.impl.repository.jdbc.repository.spgreasoner;
...
import com.antgroup.openspg.cloudext.impl.repository.jdbc.repository.spgreasoner.convertor.ReasonerJobInstConvertor;
...
public class ReasonerJobInstRepositoryImpl implements ReasonerJobInstRepository {
    ...
    public int updateExternalJobId(Long reasonerJobInstId, String externalJobInstId) {
        ...
        example.createCriteria()
            .andIdEqualTo(reasonerJobInstId);
