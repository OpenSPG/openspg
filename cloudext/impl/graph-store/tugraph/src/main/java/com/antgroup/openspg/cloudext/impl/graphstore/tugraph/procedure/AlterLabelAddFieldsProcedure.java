...
public class AlterLabelAddFieldsProcedure extends BaseTuGraphProcedure {
     ...
     * Constructor.
     */
    private AlterLabelAddFieldsProcedure(String cypherTemplate, String labelType, String labelName, String fieldSpec) {
    ...
    public static AlterLabelAddFieldsProcedure of(AlterEdgeTypeOperation alterEdgeTypeOperation) {
        List<AddPropertyOperation> addPropertyOperations = alterEdgeTypeOperation.getAtomicOperations()
            .stream()
    ...
    public static AlterLabelAddFieldsProcedure of(AlterVertexTypeOperation alterVertexTypeOperation) {
        List<AddPropertyOperation> addPropertyOperations = alterVertexTypeOperation.getAtomicOperations()
            .stream()
            .filter(atomicOperation ->
                SchemaAtomicOperationEnum.ADD_PROPERTY.equals(atomicOperation.getOperationTypeEnum()))
            .map(atomicOperation -> (AddPropertyOperation) atomicOperation)
