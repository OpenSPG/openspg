...
public class GetEdgeSchemaProcedure extends BaseTuGraphProcedure {
     ...
     * The cypher template
     */
    private static final String GET_EDGE_SCHEMA_CYPHER_TEMPLATE = "CALL db.getEdgeSchema('${labelName}')";
    ...
    public static GetEdgeSchemaProcedure of(String labelName) {
        return new GetEdgeSchemaProcedure(
            GET_EDGE_SCHEMA_CYPHER_TEMPLATE,
            labelName);
    }
