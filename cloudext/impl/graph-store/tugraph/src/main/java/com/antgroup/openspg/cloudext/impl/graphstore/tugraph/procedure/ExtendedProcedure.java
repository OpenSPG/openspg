...
/**
 * Extended procedure. PS1: Before use extended procedure, you should make sure that had uploaded .cpp/.so file to
 * TuGraph server.
 */
public class ExtendedProcedure extends BaseTuGraphProcedure {
     ...
     * Cypher template
     */
    private static final String EXTENDED_PROCEDURE_CYPHER_TEMPLATE = "CALL plugin.${pluginType}.${pluginName}('${paramsJsonString}')";
     ...
     */
    private ExtendedProcedure(String cypherTemplate, String pluginType, String pluginName, String paramsJsonString) {
    ...
    public static ExtendedProcedure of(
        Lgraph.PluginRequest.PluginType pluginType,
        String pluginName,
