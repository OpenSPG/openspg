...
public class TypeNameUtils {
  ...
  public static void convertTypeName(
    ...
    switch (schemaOperationRecord.getOperationTypeEnum()) {
      case CREATE_EDGE_TYPE:
        CreateEdgeTypeOperation createEdgeTypeOperation =
            (CreateEdgeTypeOperation) schemaOperationRecord;
      ...
      case ALTER_EDGE_TYPE:
        AlterEdgeTypeOperation alterEdgeTypeOperation =
            (AlterEdgeTypeOperation) schemaOperationRecord;
      ...
      case ALTER_VERTEX_TYPE:
        AlterVertexTypeOperation alterVertexTypeOperation =
            (AlterVertexTypeOperation) schemaOperationRecord;
      ...
      case CREATE_VERTEX_TYPE:
        CreateVertexTypeOperation createVertexTypeOperation =
            (CreateVertexTypeOperation) schemaOperationRecord;
      ...
      case DROP_VERTEX_TYPE:
        DropVertexTypeOperation dropVertexTypeOperation =
            (DropVertexTypeOperation) schemaOperationRecord;
  ...
  public static void restoreTypeName(LPGSchema lpgSchema, LPGTypeNameConvertor convertor) {
    lpgSchema
        ...
        .forEach(
            vertexType ->
                vertexType.setVertexTypeName(
                    convertor.restoreVertexTypeName(vertexType.getVertexTypeName())));
    lpgSchema
        .getEdgeTypes()
        .forEach(
            edgeType ->
