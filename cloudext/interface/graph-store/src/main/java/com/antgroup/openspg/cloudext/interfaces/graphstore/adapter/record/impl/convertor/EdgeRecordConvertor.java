...
public class EdgeRecordConvertor {
    ...
    /**
     * Convert {@link SPGPropertyRecord} in {@link BaseAdvancedRecord} into edge records. Specifically,
     * {@link BaseAdvancedRecord#getName()}, {@link BaseAdvancedRecord#getId()}, {@link SPGPropertyRecord#getName()},
     * {@link SPGTypeRef#getName()} from {@link SPGPropertyRecord}, and be assigned to start vertex's type name, start
     * vertex's ID, edge label, and end vertex's type name of {@link EdgeRecord}s. And end vertex's IDs of
     * {@link EdgeRecord}s will be split from {@link SPGPropertyRecord#getValue()}
     * </P>
     *
     * @param advancedRecord    advanced record, such as
     *                          {@link com.antgroup.openspg.core.spgbuilder.model.record.EventRecord EventRecord},
     *                          {@link com.antgroup.openspg.core.spgbuilder.model.record.EntityRecord EntityRecord}
     *                          and
     *                          {@link com.antgroup.openspg.core.spgbuilder.model.record.ConceptRecord
     *                          ConceptRecord}.
    ...
    public static RelationRecord toRelationRecord(
        ...
        String srcId, String dstId, Map<String, String> properties) {
        return new RelationRecord(
            relationType, srcId, dstId,
