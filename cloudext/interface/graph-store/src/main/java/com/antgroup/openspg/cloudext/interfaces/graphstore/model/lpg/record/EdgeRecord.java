...
/**
 * <p>
 * {@link EdgeRecord EdgeRecord} represents the persistent record of a {@link EdgeType EdgeType}, identified by start
 * vertex's ID <tt>(srcId)</tt>, end vertex's ID <tt>(dstId)</tt>, and version number <tt>(version)</tt>.
 * <strong>NOTE:</strong> If <tt>version</tt> is not specified, the default value is <strong>ZERO</strong>.
 * </P>
 */
@Getter
