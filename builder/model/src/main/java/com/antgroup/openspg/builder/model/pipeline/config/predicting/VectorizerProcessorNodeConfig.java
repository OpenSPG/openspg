...
@Getter
public class VectorizerProcessorNodeConfig extends BasePythonNodeConfig {

  public VectorizerProcessorNodeConfig(OperatorConfig operatorConfig) {
    super(NodeTypeEnum.VECTORIZER_PROCESSOR, operatorConfig);
  }
}
